...
return [
    ...
    */
    ...
    'array_value'=>'Это :attribute должно быть включено как минимум на одном языке',
    'array_unique'=>'Такое значение поля :attribute уже существует.',
    'array_update_unique'=>'Такое значение поля :attribute уже существует.',
];